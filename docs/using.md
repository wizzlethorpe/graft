...
- **The report** lists what did not build and why, then anything built with warnings, then a collapsed list of successes as clickable links. Results land in the **Compendium** tab.
